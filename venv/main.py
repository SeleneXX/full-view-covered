...
for key, value in real_sensor.items():
    draw.ellipse((key[0] * 100 - 4, key[1] * 100 - 4, key[0] * 100 + 4, key[1] * 100 + 4), fill=(100, 100, 0))
    for orientation in value:
        ...
        draw.pieslice((key[0] * 100 - 100*V_sensor.radius, key[1] * 100 - 100*V_sensor.radius, key[0] * 100 + 100*V_sensor.radius, key[1] * 100 + 100*V_sensor.radius), begin, end, outline=(255, 0, 0) )
for point in new_area.points:
    draw.ellipse((point.posx*100 - 4, point.posy*100 - 4, point.posx*100 + 4, point.posy*100 + 4), fill = (100, 0, 255))
